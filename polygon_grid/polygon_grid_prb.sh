#!/bin/bash
#
gcc -c -I/$HOME/include polygon_grid_prb.c
if [ $? -ne 0 ]; then
  echo "Errors compiling polygon_grid_prb.c"
  exit
fi
#
gcc -o polygon_grid_prb polygon_grid_prb.o /$HOME/libc/$ARCH/polygon_grid.o -lm
if [ $? -ne 0 ]; then
