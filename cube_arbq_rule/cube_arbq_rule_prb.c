...
*/
{
  ...
  timestamp ( );
  printf ( "\n" );
  printf ( "CUBE_ARBQ_RULE_PRB\n" );
  printf ( "  C version\n" );
  printf ( "  Test the CUBE_ARBQ_RULE library.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST01\n" );
  printf ( "  Symmetric quadrature rule for a cube.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST02\n" );
  printf ( "  Get a quadrature rule for the symmetric cube.\n" );
