#!/bin/bash
#
gcc -c -I/$HOME/include ellipsoid_monte_carlo_prb.c
if [ $? -ne 0 ]; then
  echo "Errors compiling ellipsoid_monte_carlo_prb.c"
  exit
fi
#
gcc -o ellipsoid_monte_carlo_prb ellipsoid_monte_carlo_prb.o /$HOME/libc/$ARCH/ellipsoid_monte_carlo.o -lm
if [ $? -ne 0 ]; then
