...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "MONO_BETWEEN_NEXT_GREVLEX - Fatal error!\n" );
    printf ( "  N1 < 0.\n" );
    exit ( 1 );
  }
  ...
  if ( i4vec_sum ( m, x ) < n1 )
  {
    printf ( "\n" );
    printf ( "MONO_BETWEEN_NEXT_GREVLEX - Fatal error!\n" );
    printf ( "  Input X sums to less than N1.\n" );
    exit ( 1 );
  }
  ...
  if ( n2 < i4vec_sum ( m, x ) )
  {
    printf ( "\n" );
    printf ( "MONO_BETWEEN_NEXT_GREVLEX - Fatal error!\n" );
    printf ( "  Input X sums to more than N2.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "MONO_BETWEEN_NEXT_GRLEX - Fatal error!\n" );
    fprintf ( stderr, "  N1 < 0.\n" );
    exit ( 1 );
  }
  ...
  if ( i4vec_sum ( m, x ) < n1 )
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "MONO_BETWEEN_NEXT_GRLEX - Fatal error!\n" );
    fprintf ( stderr, "  Input X sums to less than N1.\n" );
    exit ( 1 );
  }
  ...
  if ( n2 < i4vec_sum ( m, x ) )
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "MONO_BETWEEN_NEXT_GRLEX - Fatal error!\n" );
    fprintf ( stderr, "  Input X sums to more than N2.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "MONO_NEXT_GREVLEX - Fatal error!\n" );
    printf ( "  Input X sums to less than 0.\n" );
    exit ( 1 );
  }
/*
...
void mono_print ( int m, int f[], char *title )
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "MONO_TOTAL_NEXT_GREVLEX - Fatal error!\n" );
    printf ( "  N < 0.\n" );
    exit ( 1 );
  }
  ...
  if ( i4vec_sum ( m, x ) != n )
  {
    printf ( "\n" );
    printf ( "MONO_TOTAL_NEXT_GREVLEX - Fatal error!\n" );
    printf ( "  Input X does not sum to N.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "MONO_UPTO_NEXT_GREVLEX - Fatal error!\n" );
    printf ( "  N < 0.\n" );
    exit ( 1 );
  }
  ...
  if ( n < i4vec_sum ( m, x ) )
  {
    printf ( "\n" );
    printf ( "MONO_UPTO_NEXT_GREVLEX - Fatal error!\n" );
    printf ( "  Input X sums to more than N.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "MONO_UPTO_NEXT_GRLEX - Fatal error!\n" );
    fprintf ( stderr, "  N < 0.\n" );
    exit ( 1 );
  }
  ...
  if ( i4vec_sum ( m, x ) < 0 )
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "MONO_UPTO_NEXT_GRLEX - Fatal error!\n" );
    fprintf ( stderr, "  Input X sums to less than 0.\n" );
    exit ( 1 );
  }
  ...
  if ( n < i4vec_sum ( m, x ) )
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "MONO_UPTO_NEXT_GRLEX - Fatal error!\n" );
    fprintf ( stderr, "  Input X sums to more than N.\n" );
    exit ( 1 );
  }
