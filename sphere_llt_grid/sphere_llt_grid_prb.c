...
*/
{
  timestamp ( );
  printf ( "\n" );
  printf ( "SPHERE_LLT_GRID_TEST\n" );
  printf ( "  C version\n" );
  printf ( "  Test the SPHERE_LLT_GRID library.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "SPHERE_LLT_GRID_POINT_COUNT_TEST\n" );
  printf ( "  SPHERE_LLT_GRID_POINT_COUNT counts the points used for a\n" );
  printf ( "  grid based on triangles defined by latitude and longitude\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "SPHERE_LLT_GRID_POINTS_TEST\n" );
  printf ( "  SPHERE_LLT_POINTS produces latitude/longitude\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "SPHERE_LLT_GRID_LINE_COUNT_TEST\n" );
  printf ( "  SPHERE_LLT_GRID_LINE_COUNT counts the lines used for a\n" );
  printf ( "  grid based on triangles defined by latitude and longitude\n" );
  printf ( "  lines on a sphere in 3D.\n" );
  printf ( "\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "SPHERE_LLT_GRID_LINES_TEST\n" );
  printf ( "  SPHERE_LLT_GRID_LINES computes grid lines\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "SPHERE_LLT_GRID_DISPLAY_TEST\n" );
  printf ( "  SPHERE_LLT_GRID_DISPLAY displays an LLT grid on a sphere.\n" );
  printf ( "\n" );
  printf ( "  Number of latitudes is  %d\n", lat_num );
  printf ( "  Number of longitudes is %d\n", long_num );
/*
