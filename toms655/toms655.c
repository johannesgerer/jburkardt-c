...
*/
  ...
  if ( l < 1 || 4 < l )
  {
    printf ( "\n" );
    printf ( "CAWIQ - Fatal error!\n" );
    printf ( "  Magnitude of KEY not between 1 and 4.\n" );
    exit ( 1 );
  }
...
*/
    z = ( double * ) malloc ( nst * sizeof ( double ) );
...
*/
    xk = ( double * ) malloc ( mnm * sizeof ( double ) );
...
*/
  if ( lo != 0 )
  {
    ...
    w = ( double * ) malloc ( mmex * sizeof ( double ) );
...
*/
{
  ...
  w = ( double * ) malloc ( mex * sizeof ( double ) );
  ...
  if ( lo != 0 )
  {
    ...
    printf ( "\n" );
    printf ( "  Interpolatory quadrature formula\n" );
    printf ( "\n" );
    printf ( "  Type  Interval       Weight function               Name\n" );
    printf ( "\n" );
    if ( kind == 1 )
    {
      printf ( "    1    (a,b)              1.0                    Legendre\n" );
    }
    else if ( kind == 2 )
    {
      printf ( "    2    (a,b)      ((b-x)*(x-a))^(-0.5)          Chebyshev\n" );
    }
    else if ( kind == 3 )
    {
      printf ( "    3    (a,b)      ((b-x)*(x-a))^alpha           Gegenbauer\n" );
    }
    else if ( kind == 4 )
    {
      printf ( "    4    (a,b)    (b-x)^alpha*(x-a)^beta          Jacobi\n" );
    }
    else if ( kind == 5 )
    {
      printf ( "    5   (a,oo)   (x-a)^alpha*exp(-b*(x-a))      Gen Laguerre\n" );
    }
    else if ( kind == 6 )
    {
      printf ( "    6  (-oo,oo) |x-a|^alpha*exp(-b*(x-a)^2)  Gen Hermite\n" );
    }
    else if ( kind == 7 )
    {
      printf ( "    7    (a,b)      |x-(a+b)/2.0|^alpha        Exponential\n" );
    }
    else if ( kind == 8 )
    {
      printf ( "    8   (a,oo)    (x-a)^alpha*(x+b)^beta         Rational\n" );
    }

    printf ( "\n" );
    printf ( "     Parameters   A          %14.6f\n", a );
    printf ( "                  B          %14.6f\n", b );
    if ( 3 <= kind )
    {
      printf ( "                  alpha      %14.6f\n", alpha );
...
*/
    ...
    t2 = ( double * ) malloc ( nt * sizeof ( double ) );
...
*/
  ...
  if ( lo != 0 && kind != -1 )
  {
    if ( kindp != 0 )
    {
      ...
      if ( kindp == 1 )
      {
        printf ( "    1    (-1,+1)            1.0                    Legendre\n" );
      }
      else if ( kindp == 2 )
      {
        printf ( "    2    (-1,+1)    ((b-x)*(x-a))^(-0.5)          Chebyshev\n" );
      }
      else if ( kindp == 3 )
      {
        printf ( "    3    (-1,+1)    ((b-x)*(x-a))^alpha           Gegenbauer\n" );
      }
      else if ( kindp == 4 )
      {
        printf ( "    4    (-1,+1)  (b-x)^alpha*(x-a)^beta          Jacobi\n" );
      }
      else if ( kindp == 5 )
      {
        printf ( "    5   (0,oo)   (x-a)^alpha*exp(-b*(x-a))      Gen Laguerre\n" );
      }
      else if ( kindp == 6 )
      {
        printf ( "    6  (-oo,oo) |x-a|^alpha*exp(-b*(x-a)^2)  Gen Hermite\n" );
      ...
      {
        printf ( "    7    (-1,+1)    |x-(a+b)/2.0|^alpha        Exponential\n" );
      }
      else if ( kindp == 8 )
      {
        printf ( "    8   (0,oo)    (x-a)^alpha*(x+b)^beta         Rational\n" );
      }
    ...
    if ( kind != -1 )
    {
      prec = r8_epsilon ( );
      printf ( "\n" );
      printf ( "  Machine precision = %14.6g\n", prec );
    }

    printf ( "\n" );
    printf ( "           Knots               Mult                Weights\n" );
    printf ( "\n" );
    ...
    for ( i = 1; i <= nt; i++ )
    {
      ...
      if ( k != 0 )
      {
        printf ( "%4d%26.17g%4d%26.17g\n", i, t[i-1], mlt[i-1], wts[k-1] );
...
*/
  ...
  e = ( double * ) malloc ( mex * sizeof ( double ) );
  er = ( double * ) malloc ( mex * sizeof ( double ) );
  qm = ( double * ) malloc ( mex * sizeof ( double ) );
...
*/
  ...
  if ( 0 < lo ) 
  {
    ...
    printf ( "\n" );
    printf ( "  Comparison of moments\n" );
    printf ( "\n" );
    printf ( "  Order of precision %d\n", mop );
    printf ( "  Errors :    Absolute    Relative\n" );
    printf ( "  ---------+-------------------------\n" );
    printf ( "  Minimum :%12.3e  %12.3e\n", emn, ern );
    printf ( "  Maximum :%12.3e  %12.3e\n", emx, erx );
    printf ( "\n" );
    printf ( "  Weights ratio       %12.3f\n", erest );
    ...
    if ( m <= mex )
    {
      ...
      printf ( "  Error in %dth power %12.3e\n", mop, e[m-1] );
      printf ( "  Error constant      %12.3f\n", ek );
    }

    printf ( "\n" );
    printf ( "  Moments:\n" );
    printf ( "\n" );
    printf ( "            True             from QF            Error      Relative\n" );
    printf ( "\n" );
    for ( j = 1; j <= mx; j++ )
    {
      printf ( "%4d%19.10e%19.10e%12.3e%12.3e\n", j, w[j-1], qm[j-1], e[j-1], er[j-1] );
    }
    printf ( "\n" );
    for ( j = m; j <= mex; j++ )
    {
...
*/
  aj = ( double * ) malloc ( nst * sizeof ( double ) );
  bj = ( double * ) malloc ( nst * sizeof ( double ) );
...
*/
{
  ...
  wf = ( double * ) malloc ( nstar * sizeof ( double ) );
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "EIQF - Fatal error!\n" );
    printf ( "  Magnitude of KEY must be between 1 and 4.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "SCT - Fatal error!\n" );
    printf ( "  KIND falls outside range of 1 to 8.\n" );
    exit ( 1 );
  }
  ...
  st = ( double * ) malloc ( nt * sizeof ( double ) );
...
*/
{
  ...
  {
    w[0] = sqrt ( pi ) * r8_gamma ( alpha + 1.0 ) 
  ...
  {
    als = alpha + beta + 1.0;
    w[0] = pow ( 2.0, als ) * r8_gamma ( alpha + 1.0 ) 
