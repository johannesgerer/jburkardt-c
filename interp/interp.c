...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "CC_ABSCISSAS_AB - Fatal error\n" );
    fprintf ( stderr, "  N < 1.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "F1_ABSCISSAS - Fatal error\n" );
    fprintf ( stderr, "  N < 1.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "F1_ABSCISSAS_AB - Fatal error\n" );
    fprintf ( stderr, "  N < 1.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "F2_ABSCISSAS - Fatal error\n" );
    fprintf ( stderr, "  N < 1.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "F2_ABSCISSAS_AB - Fatal error\n" );
    fprintf ( stderr, "  N < 1.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "INTERP_LINEAR - Fatal error\n" );
    fprintf ( stderr, 
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "NCC_ABSCISSAS - Fatal error\n" );
    fprintf ( stderr, "  N < 1.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "NCC_ABSCISSAS_AB - Fatal error\n" );
    fprintf ( stderr, "  N < 1.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "NCO_ABSCISSAS - Fatal error\n" );
    fprintf ( stderr, "  N < 1.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "NCO_ABSCISSAS_AB - Fatal error\n" );
    fprintf ( stderr, "  N < 1.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  t_data = ( double * ) malloc ( data_num * sizeof ( double ) );
