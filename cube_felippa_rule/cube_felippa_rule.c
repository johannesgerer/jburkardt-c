...
void cube_rule ( double a[], double b[], int order_1d[], double w[], 
  double xyz[] )
...
*/
{
  ...
  for ( i = 0; i < 3; i++ )
  {
    ...
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "CUBE_RULE - Fatal error!\n" );
...
*/
    r8vec_direct_product ( i, o, x_1d, 3, order, xyz );

    r8vec_direct_product2 ( i, o, w_1d, 3, order, w );
