...
#  "ring.oJOBID" where JOBID is a job id number assigned when the job is
#  submitted.
#
#MOAB -j oe
#
...
#
mpirun -np 8 ./ring > ring_fsu_output.txt
#
#  Clean up.
#
rm ring
#
echo "Program output written to ring_fsu_output.txt"
