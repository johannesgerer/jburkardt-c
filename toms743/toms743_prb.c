...
*/
  printf ( "\n" );
  printf ( "TEST01\n" );
  printf ( "  Compare WAPR(X) to stored values.\n" );
/*
  Wp results for x near -exp(-1).
*/
  printf ( "\n" );
  printf ( "  Wp results for x near -exp(-1)\n" );
  printf ( "\n" );
  printf ( "   Offset x    W(x) (WAPR)" );
  printf ( "   W(x) (EXACT)   Digits Correct\n" );
  printf ( "\n" );
  ...
  for ( i = 0; i < 68; i++ )
  {
    ...
    printf ( "%17.8e%17.8e%17.8e      %3d\n", dx1[i], w, wp1[i], nd );
  }
/*
  Wp results for x near 0.
*/
  printf ( "\n" );
  printf ( "  Wp results for x near 0\n" );
  printf ( "\n" );
  printf ( "      x    W(x) (WAPR)" );
  printf ( "     W(x) (EXACT)   Digits Correct\n" );
  printf ( "\n" );
...
*/
  printf ( "\n" );
  printf ( "  Wm results for x near 0\n" );
  printf ( "\n" );
  printf ( "      x    W(x) (WAPR)" );
  printf ( "     W(x) (EXACT)   Digits Correct\n" );
  printf ( "\n" );
...
*/
  printf ( "\n" );
  printf ( "  Wm results for x near -exp(-1)\n" );
  printf ( "\n" );
  printf ( "   Offset x    W(x) (WAPR)" );
  printf ( "     W(x) (EXACT)   Digits Correct\n" );
  printf ( "\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST02\n" );
  printf ( "  Input X is the offset from -exp(-1).\n" );
  ...
  {
    iw = 1;
    printf ( "  Both branches of the W function will be checked.\n" );
  }
  else
  {
    iw = 0;
    printf ( "  Wp has been selected (maximum x is > 0)\n" );
  }

  printf ( "\n" );
  printf ( "  Results for Wp(x):\n" );

  if ( ifmt == 0 )
  {
    printf ( "\n" );
    printf ( "   Offset x    W(x) (WAPR)" );
    printf ( "     W(x) (BISECT)  Digits Correct\n" );
  }
  else
  {
    printf ( "\n" );
  ...
  for ( i = 1; i <= n + 1; i++ )
  {
    ...
    if ( nerror == 1 )
    {
      printf ( "  The value of X = %g is out of range.\n", x );
    }
    else
    {
      we = bisect ( x, 0, &ner, l );
      ...
      {
        printf ( "\n" );
        printf ( " BISECT did not converge for x = %g\n", x );
        printf ( "  Try reducing NBITS.\n" );
      }
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST03\n" );
  printf ( "  Input X is the argument.\n" );
