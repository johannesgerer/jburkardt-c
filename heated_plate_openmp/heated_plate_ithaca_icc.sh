...
#
icc -openmp -parallel heated_plate_openmp.c
#
...
./heated_plate > heated_plate_ithaca_icc_output.txt
#
...
rm heated_plate
#
echo "Program output written to heated_plate_ithaca_icc_output.txt."
