...
*/
{
  ...
  printf ( "\n" );
  printf ( "EXACTNESS_PRB\n" );
  printf ( "  C version\n" );
  printf ( "  Test the EXACTNESS library.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST01\n" );
  printf ( "  Gauss-Legendre rules for the Legendre integral.\n" );
  printf ( "  Density function rho(x) = 1.\n" );
  printf ( "  Region: -1 <= x <= +1.\n" );
  printf ( "  Exactness: 2*N-1.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST015\n" );
  printf ( "  Fejer Type 1 rules for the Legendre integral.\n" );
  printf ( "  Density function rho(x) = 1.\n" );
  printf ( "  Region: -1 <= x <= +1.\n" );
  printf ( "  Exactness: N   for N odd,\n" );
  printf ( "             N-1 for N even.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST02\n" );
  printf ( "  Fejer Type 2 rules for the Legendre integral.\n" );
  printf ( "  Density function rho(x) = 1.\n" );
  printf ( "  Region: -1 <= x <= +1.\n" );
  printf ( "  Exactness: N   for N odd,\n" );
  printf ( "             N-1 for N even.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST03\n" );
  printf ( "  Clenshaw-Curtis rules for the Legendre integral.\n" );
  printf ( "  Density function rho(x) = 1.\n" );
  printf ( "  Region: -1 <= x <= +1.\n" );
  printf ( "  Exactness: N   for N odd,\n" );
  printf ( "             N-1 for N even.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST04\n" );
  printf ( "  Gauss-Laguerre rules for the Laguerre integral.\n" );
  printf ( "  Density function rho(x) = exp(-x).\n" );
  printf ( "  Region: 0 <= x < +oo.\n" );
  printf ( "  Exactness: 2N-1.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST06\n" );
  printf ( "  Gauss-Hermite rules for the Hermite integral.\n" );
  printf ( "  Density function rho(x) = exp(-x^2).\n" );
  printf ( "  Region: -oo < x < +oo.\n" );
  printf ( "  Exactness: 2N-1.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST08\n" );
  printf ( "  Gauss-Chebyshev1 rules for the Chebyshev1 integral.\n" );
  printf ( "  Density function rho(x) = 1/sqrt(1-x^2).\n" );
  printf ( "  Region: -1 <= x <= +1.\n" );
  printf ( "  Exactness: 2N-1.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST085\n" );
  printf ( "  Gauss-Chebyshev3 rules for the Chebyshev1 integral.\n" );
  printf ( "  Density function rho(x) = 1/sqrt(1-x^2).\n" );
  printf ( "  Region: -1 <= x <= +1.\n" );
  printf ( "  Exactness: 2N-3.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST09\n" );
  printf ( "  Gauss-Chebyshev2 rules for the Chebyshev2 integral.\n" );
  printf ( "  Density function rho(x) = sqrt(1-x^2).\n" );
  printf ( "  Region: -1 <= x <= +1.\n" );
  printf ( "  Exactness: 2N-1.\n" );
