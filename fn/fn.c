...
*/
{
  ...
  value = ( complex ) ( cs * cosh ( y ), - sin ( x ) * sinh ( y ) );

  return value;
}
/******************************************************************************/

complex c4_sin ( complex z )
...
*/
{
  ...
  value = ( complex ) ( sn * cosh ( y ), cos ( x ) * sinh ( y ) );
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "  Current random number table:\n" );
    printf ( "\n" );
    for ( i = 0; i < 33; i++ )
    {
      printf ( "  %d  %g\n", i, t[i] );
