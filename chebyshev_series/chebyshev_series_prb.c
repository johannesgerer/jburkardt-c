...
*/
{
  timestamp ();
  printf ( "\n" );
  printf ( "CHEBYSHEV_SERIES_PRB:\n" );
  printf ( "  C version\n" );
  printf ( "  Test the CHEBYSHEV_SERIES libary.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST01:\n" );
  printf ( "  ECHEBSER3 computes a Chebyshev series approximation\n" );
  printf ( "  and the first three derivatives.\n" );
  printf ( "\n" );
  printf ( "  Errors of a Chebyshev series for exp(x)\n" );
  printf ( "\n" );
  printf ( "    x        err(y)       err(y')       err(y\")      err(y\"')\n" );
  printf ( "\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST02:\n" );
  printf ( "  EVENCHEBSER2 computes an even Chebyshev series\n" );
  printf ( "  and its first two derivatives.\n" );
  printf ( "\n" );
  printf ( "  Errors of an even Chebyshev series for cos(pi*x/2):\n" );
  printf ( "\n" );
  printf ( "    x        err(y)       err(y')       err(y\")\n" );
  printf ( "\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST03:\n" );
  printf ( "  ODDCHEBSER2 computes an odd Chebyshev series approximation.\n" );
  printf ( "  and its first two derivatives.\n" );
  printf ( "\n" );
  printf ( "  Errors of an odd Chebyshev series y(x) approximating sinh(x):\n" );
  printf ( "\n" );
  printf ( "    x        err(y)       err(y')       err(y\")\n" );
  printf ( "\n" );
