#!/bin/bash
#
gcc -c -g -I/$HOME/include rbf_interp_2d_prb.c >& compiler.txt
if [ $? -ne 0 ]; then
  echo "Errors compiling rbf_interp_2d_prb.c"
  exit
fi
rm compiler.txt
#
gcc rbf_interp_2d_prb.o /$HOME/libc/$ARCH/rbf_interp_2d.o /$HOME/libc/$ARCH/test_interp_2d.o /$HOME/libc/$ARCH/r8lib.o -lm
if [ $? -ne 0 ]; then
