...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "CSEVL - Fatal error!\n" );
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "INITS - Fatal error!\n" );
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "P00_D - Fatal error!\n" );
    fprintf ( stderr, "  Illegal spatial coordinate ID = %d\n", id );
    exit ( 1 );
  }
  ...
  else
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "P00_D - Fatal error!\n" );
    fprintf ( stderr, "  Illegal function index PROB = %d\n", prob );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "P00_Q - Fatal error!\n" );
    fprintf ( stderr, "  Illegal function index PROB = %d\n", prob );
    exit ( 1 );
  }
...
/*
  ...
  Parameters:
    ...
    Output, char *P00_TITLE, the function title.
*/
{
  char *title;
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "R8_ERRORC - Warning!\n" );
