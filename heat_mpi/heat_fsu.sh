...
#  "heat.oJOBID" where JOBID is a job id number assigned when the job is
#  submitted.
#
#MOAB -j oe
#
...
#
mpirun -np 8 ./heat > heat_fsu_output.txt
#
#  Clean up.
#
rm heat
#
echo "Program output written to heat_fsu_output.txt"
