...
double *circle_grid ( int n, double r, double c[2], int ng )
...
/*
  ...
  Parameters:
    ...
    Output, double CIRCLE_GRID[2*NG], the grid points inside the circle.
*/
{
  double *cg;
  int i;
...
int circle_grid_count ( int n, double r, double c[2] )
...
/*
  ...
  Parameters:
    ...
    Output, int CIRCLE_GRID_COUNT, the number of grid points inside 
    the circle.
*/
{
  int i;
