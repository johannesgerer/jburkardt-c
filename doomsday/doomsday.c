...
*/
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "DOOMSDAY_GREGORIAN - Fatal error!\n" );
    fprintf ( stderr, "  Y <= 0.\n" );
    exit ( 1 );
  }
/*
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "YEAR_IS_LEAP_GREGORIAN - Fatal error!\n" );
    fprintf ( stderr, "  This function will not accept nonpositive years.\n" );
    exit ( 1 );
  }
