...
/*
  Factor.
*/
  info = sgbfa ( abd, lda, n, ml, mu, ipvt );
/*
...
*/
  ...
  for ( k = 1; k <= n; k++ )
  {
    ...
    if ( r4_abs ( abd[m-1+(k-1)*lda] ) < r4_abs ( ek - z[k-1] ) )
    {
      s = r4_abs ( abd[m-1+(k-1)*lda] ) / r4_abs ( ek - z[k-1] );
      for ( i = 1; i <= n; i++ )
      {
        z[i-1] = s * z[i-1];
      }
    ...
    if ( k+1 <= ju )
    {
      ...
      {
        mm = mm - 1;
        sm = sm + r4_abs ( z[j-1] + wkm * abd[mm-1+(j-1)*lda] );
...
*/
  for ( k = n; 1 <= k; k-- )
  {
    if ( r4_abs ( abd[m-1+(k-1)*lda] ) < r4_abs ( z[k-1] ) )
    {
      s = r4_abs ( abd[m-1+(k-1)*lda] ) / r4_abs ( z[k-1] );
      for ( i = 1; i <= n; i++ )
      {
        z[i-1] = s * z[i-1];
      }
...
*/
{
  ...
  for ( i = 1; i <= n; i++ )
  {
    ...
    while ( r4_abs ( det[0] ) < 1.0 )
    {
      det[0] = det[0] * 10.0;
      det[1] = det[1] - 1.0;
    }

    while ( 10.0 <= r4_abs ( det[0] ) )
    {
      det[0] = det[0] / 10.0;
      det[1] = det[1] + 1.0;
    }
...
*/
  ...
  for ( k = 1; k <= n; k++ )
  {
    ...
    if ( r4_abs ( a[k-1+(k-1)*lda] ) < r4_abs ( ek - z[k-1] ) )
    {
      s = r4_abs ( a[k-1+(k-1)*lda] ) / r4_abs ( ek - z[k-1] );
      for ( i = 1; i <= n; i++ )
      {
        z[i-1] = s * z[i-1];
      }
    ...
    if ( k+1 <= n )
    {
      for ( j = k+1; j <= n; j++ )
      {
        sm = sm + r4_abs ( z[j-1] + wkm * a[k-1+(j-1)*lda] );
...
*/
  for ( k = n; 1 <= k; k-- )
  {
    if ( r4_abs ( a[k-1+(k-1)*lda] ) < r4_abs ( z[k-1] ) )
    {
      s = r4_abs ( a[k-1+(k-1)*lda] ) / r4_abs ( z[k-1] );
      for ( i = 1; i <= n; i++ )
      {
        z[i-1] = s * z[i-1];
      }
...
*/
  for ( j = 1; j <= n; j++ )
  {
    ...
    {
      k = k + 1;
      z[k-1] = z[k-1] + r4_abs ( abd[i-1+(j-1)*lda] );
    }
  }
  anorm = 0.0;
  for ( i = 1; i <= n; i++ )
...
*/
  ...
  for ( k = 1; k <= n; k++ )
  {
    ...
    if ( abd[m+(k-1)*lda] < r4_abs ( ek - z[k-1] ) )
    {
      s = abd[m+(k-1)*lda] / r4_abs ( ek - z[k-1] );
      for ( i = 1; i <= n; i++ )
      {
        z[i-1] = s * z[i-1];
      }
    ...
    if ( k+1 <= j2 )
    {
      ...
      {
        i = i - 1;
        sm = sm + r4_abs ( z[j-1] + wkm * abd[i-1+(j-1)*lda] );
...
*/
  for ( k = n; 1 <= k; k-- )
  {
    if ( abd[m+(k-1)*lda] < r4_abs ( z[k-1] ) )
    {
      s = abd[m+(k-1)*lda] / r4_abs ( z[k-1] );
      for ( i = 1; i <= n; i++ )
      {
        z[i-1] = s * z[i-1];
      }
...
*/
  for ( j = 1; j <= n; j++ )
  {
    ...
    for ( i = 1; i <= j-1; i++ )
    {
      z[i-1] = z[i-1] + r4_abs ( a[i-1+(j-1)*lda] );
    }
  }
...
*/
  ...
  for ( k = 1; k <= n; k++ )
  {
    ...
    if ( a[k-1+(k-1)*lda] < r4_abs ( ek - z[k-1] ) )
    {
      s = a[k-1+(k-1)*lda] / r4_abs ( ek - z[k-1] );
      for ( i = 1; i <= n; i++ )
      {
        z[i-1] = s * z[i-1];
      }
...
*/
  for ( k = n; 1 <= k; k-- )
  {
    if ( a[k-1+(k-1)*lda] < r4_abs ( z[k-1] ) )
    {
      s = a[k-1+(k-1)*lda] / r4_abs ( z[k-1] );
      for ( i = 1; i <= n; i++ )
      {
        z[i-1] = s * z[i-1];
      }
...
*/
  ...
  for ( k = 1; k <= n; k++ )
  {
    ...
    if ( ap[kk-1] < r4_abs ( ek - z[k-1] ) )
    {
      s = ap[kk-1] / r4_abs ( ek - z[k-1] );
      for ( i = 1; i <= n; i++ )
      {
        z[i-1] = s * z[i-1];
      }
    ...
    if ( k + 1 <= n )
    {
      for ( j = k + 1; j <= n; j++ )
      {
        sm = sm + r4_abs ( z[j-1] + wkm * ap[kj-1] );
...
*/
  for ( k = n; 1 <= k; k-- )
  {
    if ( ap[kk-1] < r4_abs ( z[k-1] ) )
    {
      s = ap[kk-1] / r4_abs ( z[k-1] );
      for ( i = 1; i <= n; i++ )
      {
        z[i-1] = s * z[i-1];
      }
...
*/
    ...
    if ( l != n )
    {
      ...
      if ( nrmxl != 0.0 )
      {
        ...
        {
          nrmxl = nrmxl * r4_sign ( a[l-1+(l-1)*lda] );
        }
...
*/
        for ( j = l + 1; j <= p; j++ )
        {
          ...
          if ( pl <= j && j <= pu )
          {
            if ( qraux[j-1] != 0.0 )
            {
              tt = 1.0 - pow ( r4_abs ( a[l-1+(j-1)*lda] ) / qraux[j-1], 2 );
              tt = r4_max ( tt, 0.0 );
              t = tt;
...
*/
    else
    {
      ...
      for ( j = imaxp1; j <= k; j++ )
      {
        rowmax = r4_max ( rowmax, r4_abs ( a[imax-1+(j-1)*lda] ) );
      }

      if ( imax != 1 )
      {
        jmax = isamax ( imax-1, a+0+(imax-1)*lda, 1 );
        rowmax = r4_max ( rowmax, r4_abs ( a[jmax-1+(imax-1)*lda] ) );
      }

      if ( alpha * rowmax <= r4_abs ( a[imax-1+(imax-1)*lda] ) )
      {
        kstep = 1;
        swap = 1;
      }
...
*/
  ...
  while ( k != 0 )
  {
    ...
    if ( ks != 2 )
    {
      if ( r4_abs ( ap[kk-1] ) < r4_abs ( z[k-1] ) )
      {
        s = r4_abs ( ap[kk-1] ) / r4_abs ( z[k-1] );
        for ( i = 1; i <= n; i++ )
        {
          z[i-1] = s * z[i-1];
        }
...
*/
    km1 = k - 1;
    kk = ik + k;
    absakk = r4_abs ( ap[kk-1] );
/*
  Determine the largest off-diagonal element in column K.
*/
    imax = isamax ( k-1, ap+ik, 1 );
    imk = ik + imax;
    colmax = r4_abs ( ap[imk-1] );
...
*/
    else
    {
      ...
      for ( j = imaxp1; j <= k; j++ )
      {
        rowmax = r4_max ( rowmax, r4_abs ( ap[imj-1] ) );
        imj = imj + j;
      }
      ...
      if ( imax != 1 )
      {
        ...
        jmim = jmax + im;
        rowmax = r4_max ( rowmax, r4_abs ( ap[jmim-1] ) );
      }

      imim = imax + im;

      if ( alpha * rowmax <= r4_abs ( ap[imim-1] ) )
      {
        kstep = 1;
        swap = 1;
      }
...
*/
    if ( l <= nct )
    {
      ...
      if ( s[l-1] != 0.0 )
      {
        if ( a[l-1+(l-1)*lda] != 0.0 )
        {
          s[l-1] = r4_sign ( a[l-1+(l-1)*lda] ) * r4_abs ( s[l-1] );
        }
...
*/
      ...
      if ( e[l-1] != 0.0 )
      {
        if ( e[l] != 0.0 )
        {
          e[l-1] = r4_sign ( e[l] ) * r4_abs ( e[l-1] );
        }
...
*/
    for ( ll = 1; ll <= mn; ll++ )
    {
      ...
      test = r4_abs ( s[l-1] ) + r4_abs ( s[l] );
      ztest = test + r4_abs ( e[l-1] );
    ...
    else
    {
      ...
      for ( lls = l+1; lls <= mn+1; lls++ )
      {
        ...
        if ( ls != mn )
        {
          test = test + r4_abs ( e[ls-1] );
        }

        if ( ls != l + 1 )
        {
          test = test + r4_abs ( e[ls-2] );
        }

        ztest = test + r4_abs ( s[ls-1] );
...
/*
  Calculate the shift.
*/
      scale = r4_max ( r4_abs ( s[mn-1] ), 
              r4_max ( r4_abs ( s[mn-2] ), 
              r4_max ( r4_abs ( e[mn-2] ), 
              r4_max ( r4_abs ( s[l-1] ), r4_abs ( e[l-1] ) ) ) ) );
...
*/
  ...
  for ( kk = 1; kk <= n; kk++ )
  {
    ...
    if ( r4_abs ( t[k-1+(k-1)*ldt] ) < r4_abs ( ek - z[k-1] ) )
    {
      s = r4_abs ( t[k-1+(k-1)*ldt] ) / r4_abs ( ek - z[k-1] );
      for ( i = 1; i <= n; i++ )
      {
        z[i-1] = s * z[i-1];
      }
    ...
    if ( kk != n )
    {
      ...
      for ( j = j1; j <= j2; j++ )
      {
        sm = sm + r4_abs ( z[j-1] + wkm * t[k-1+(j-1)*ldt] );
...
*/
  for ( kk = 1; kk <= n; kk++ )
  {
    ...
    if ( r4_abs ( t[k-1+(k-1)*ldt] ) < r4_abs ( z[k-1] ) )
    {
      s = r4_abs ( t[k-1+(k-1)*ldt] ) / r4_abs ( z[k-1] );
      for ( i = 1; i <= n; i++ )
      {
        z[i-1] = s * z[i-1];
      }
