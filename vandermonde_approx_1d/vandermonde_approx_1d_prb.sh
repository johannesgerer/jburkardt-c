#!/bin/bash
#
gcc -c -g -I/$HOME/include vandermonde_approx_1d_prb.c >& compiler.txt
if [ $? -ne 0 ]; then
  echo "Errors compiling vandermonde_approx_1d_prb.c"
  exit
fi
rm compiler.txt
#
gcc vandermonde_approx_1d_prb.o /$HOME/libc/$ARCH/vandermonde_approx_1d.o \
