...
/*
  Purpose:
    ...
    Z_SAMPLE tests the SUPERLU solver with a 5x5 double precision complex matrix.
...
# define NCC 12
  ...
  SuperMatrix A;
  doublecomplex acc[NCC] = { 
    ( doublecomplex ) { 19.0, 0.0 }, 
    ( doublecomplex ) { 12.0, 0.0 },
    ( doublecomplex ) { 12.0, 0.0 },
    ( doublecomplex ) { 21.0, 0.0 },
    ( doublecomplex ) { 12.0, 0.0 },
    ( doublecomplex ) { 12.0, 0.0 },
    ( doublecomplex ) { 21.0, 0.0 },
    ( doublecomplex ) { 16.0, 0.0 },
    ( doublecomplex ) { 21.0, 0.0 },
    ( doublecomplex ) {  5.0, 0.0 },
    ( doublecomplex ) { 21.0, 0.0 },
    ( doublecomplex ) { 18.0, 0.0 } };
  SuperMatrix B;
  doublecomplex *b;
  doublecomplex *b2;
