...
/*
  Purpose:
    ...
    S_SAMPLE_HB tests the SUPERLU solver with a 5x5 single precision real matrix.
...
/*
  ...
  in Harwell-Boeing (HB) format, into compressed column (CC) format.
*/
  sreadhb ( &m, &n, &ncc, &acc, &icc, &ccc );
/*
  Print the matrix.
*/
