...
int main ( );
doublecomplex *cc_mv ( int m, int n, int ncc, int icc[], int ccc[], doublecomplex acc[], 
  doublecomplex x[] );
...
/*
  Purpose:
    ...
    Z_SAMPLE_HB tests the SUPERLU solver with a 5x5 double precision complex matrix.
