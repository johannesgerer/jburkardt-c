...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "T_DOUBLE_PRODUCT_INTEGRAL - Fatal error!\n" );
    printf ( "  0 <= I, is required.\n" );
    exit ( 1 );
  }
  if ( j < 0 )
  {
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "T_PROJECT_COEFFICIENTS_DATA- Fatal error!\n" );
    fprintf ( stderr, "  Some X not in [A,B].\n" );
    exit ( 1 );
  }
/*
...
*/
{
  ...
  b0 = ( double * ) malloc ( m * sizeof ( double ) );
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "T_TRIPLE_PRODUCT_INTEGRAL - Fatal error!\n" );
    fprintf ( stderr, "  0 <= I is required.\n" );
    exit ( 1 );
  }
  ...
  if ( j < 0 )
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "T_TRIPLE_PRODUCT_INTEGRAL - Fatal error!\n" );
    fprintf ( stderr, "  0 <= J is required.\n" );
    exit ( 1 );
  }
  ...
  if ( k < 0 )
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "T_TRIPLE_PRODUCT_INTEGRAL - Fatal error!\n" );
    fprintf ( stderr, "  0 <= K is required.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "U_DOUBLE_PRODUCT_INTEGRAL - Fatal error!\n" );
    printf ( "  0 <= I, is required.\n" );
    exit ( 1 );
  }
  if ( j < 0 )
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "V_DOUBLE_PRODUCT_INTEGRAL - Fatal error!\n" );
    printf ( "  0 <= I, is required.\n" );
    exit ( 1 );
  }
  if ( j < 0 )
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "W_DOUBLE_PRODUCT_INTEGRAL - Fatal error!\n" );
    printf ( "  0 <= I, is required.\n" );
    exit ( 1 );
  }
  if ( j < 0 )
