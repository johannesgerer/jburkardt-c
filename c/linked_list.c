...
/*
  Purpose:
    ...
    MAIN is the main program for LINKED_LIST.
...
*/
{
  ...
  printf ( "LINKED_LIST:\n" );
  printf ( "  C version\n" );
  printf ( "  Demonstrate how a linked list can be used to create a\n" );
  printf ( "  dynamically growing list of objects.\n" );
  printf ( "\n" );
  
  seed = 123456789;
/*
  Now pick a random number of objects.  In actual use, one typically does
...
*/
    ...
    printf ( "  Setting pop = %d for item k = %d\n", pop, k );
/*
...
/*
  OK, now try to retrieve stuff from the list!
*/
  printf ( "\n" );
  printf ( "  Number of items, K_NUM = %d\n", k_num );
/*
