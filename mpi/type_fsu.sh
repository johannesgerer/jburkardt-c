...
#  "type.oJOBID" where JOBID is a job id number assigned when the job is
#  submitted.
#
#MOAB -j oe
#
...
#
mpirun -np 8 ./type > type_fsu_output.txt
#
#  Clean up.
#
rm type
#
echo "Program output written to type_fsu_output.txt"
