...
*/
{
  ...
  if ( mmax == 0 )
  {
    pols = ( double * ) malloc ( 1 * sizeof ( double ) );

    pols[0] = 1.0 / sqrt ( 3.0 ) * sqrt ( sqrt ( 3.0 ) );
  }
  else if ( mmax == 1 )
  {
    pols = ( double * ) malloc ( 3 * sizeof ( double ) );
...
*/
{
  ...
  pols = ( double * ) malloc ( npols * sizeof ( double ) );
...
*/
  ...
  f2 = ( double * ) malloc ( ( mmax + 1 ) * ( mmax + 1 ) * sizeof ( double ) );
...
*/
  ...
  xf = ( double * ) malloc ( nf * sizeof ( double ) );
  yf = ( double * ) malloc ( nf * sizeof ( double ) );
  wf = ( double * ) malloc ( nf * sizeof ( double ) );
...
void triasymq_gnuplot ( double vert1[], double vert2[], double vert3[], 
  int numnodes, double rnodes[], char *header )
