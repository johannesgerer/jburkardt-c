...
*/
{
  ...
  pols = ( double * ) malloc ( ( degree + 1 ) * sizeof ( double ) );
  pkp1 = 1.0;
  pols[0] = pkp1;
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "SQUARE_ARBQ - Fatal error\n" );
...
void square_arbq_gnuplot ( int n, double x[], char *header )
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "SQUARE_ARBQ_SIZE - Fatal error!\n" );
    fprintf ( stderr, "  Illegal value of DEGREE.\n" );
    exit ( 1 );
  }
