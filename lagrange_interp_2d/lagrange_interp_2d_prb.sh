#!/bin/bash
#
gcc -c -g -I/$HOME/include lagrange_interp_2d_prb.c >& compiler.txt
if [ $? -ne 0 ]; then
  echo "Errors compiling lagrange_interp_2d_prb.c"
  exit
fi
rm compiler.txt
#
gcc lagrange_interp_2d_prb.o /$HOME/libc/$ARCH/lagrange_interp_2d.o \
