...
#  "satisfy.oJOBID" where JOBID is a job id number assigned when the job is
#  submitted.
#
#MOAB -j oe
#
...
#
mpirun -np 8 ./satisfy > satisfy_fsu_output.txt
#
#  Clean up.
#
rm satisfy
#
echo "Program output written to satisfy_fsu_output.txt"
