#!/bin/bash
#
gcc -c -g -I/$HOME/include vandermonde_interp_1d_prb.c >& compiler.txt
if [ $? -ne 0 ]; then
  echo "Errors compiling vandermonde_interp_1d_prb.c"
  exit
fi
rm compiler.txt
#
gcc vandermonde_interp_1d_prb.o /$HOME/libc/$ARCH/vandermonde_interp_1d.o \
                                /$HOME/libc/$ARCH/condition.o \
