...
/*
  Declare the constituent routines:
*/
...
*/
  (void) strcpy ( file_temp_name, "fsplit.XXXXX" );
/*
  MKTEMP replaces the 'X' characters in FILE_TEMP_NAME by characters that
  result in a unique file name.
*/
  (void) mktemp ( file_temp_name );
/*
