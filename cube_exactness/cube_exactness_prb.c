...
*/
{
  ...
  printf ( "\n" );
  printf ( "CUBE_EXACTNESS_PRB\n" );
  printf ( "  C version\n" );
  printf ( "  Test the CUBE_EXACTNESS library.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST01\n" );
  printf ( "  Product Gauss-Legendre rules for the 3D Legendre integral.\n" );
  printf ( "  Density function rho(x) = 1.\n" );
  printf ( "  Region: -1 <= x <= +1.\n" );
  printf ( "          -1 <= y <= +1.\n" );
  printf ( "          -1 <= z <= +1.\n" );
  printf ( "  Level: L\n" );
  printf ( "  Exactness: 2*L+1\n" );
  printf ( "  Order: N = (L+1)*(L+1)*(L+1)\n" );
...
*/
{
  ...
  printf ( "          -1 <= y <= +1.\n" );
  printf ( "          -1 <= z <= +1.\n" );
  printf ( "  Exactness: 3 = 2 * min ( 2, 3, 4 ) - 1\n" );
  printf ( "  Order: N = 2 * 3 * 4\n" );
...
*/
{
  ...
  else
  {
    ...
    fprintf ( stderr, "  Legal values are 1:10.\n" );
    exit ( 1 );
  }
  return;
}