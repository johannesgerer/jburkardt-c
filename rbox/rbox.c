/*
   ...
   WARNING: 
     incorrect range if qh_RANDOMmax is defined wrong (rbox.h)
*/
...
int main ( int argc, char **argv )
{
  ...
  int issphere=0, isaxis=0,  iscdd= 0, islens= 0;
  int isregular=0, iswidth=0, addcube=0;
