#!/bin/bash
#
gcc -c -g -I/$HOME/include sgmga_vcn_coef_prb.c >& compiler.txt
if [ $? -ne 0 ]; then
  echo "Errors compiling sgmga_vcn_coef_prb.c."
  exit
fi
rm compiler.txt
#
gcc sgmga_vcn_coef_prb.o /$HOME/libc/$ARCH/sgmga.o /$HOME/libc/$ARCH/sandia_rules.o -lm
if [ $? -ne 0 ]; then
