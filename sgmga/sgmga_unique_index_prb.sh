#!/bin/bash
#
gcc -c -g -I/$HOME/include sgmga_unique_index_prb.c >& compiler.txt
if [ $? -ne 0 ]; then
  echo "Errors compiling sgmga_unique_index_prb.c."
  exit
fi
rm compiler.txt
#
gcc sgmga_unique_index_prb.o /$HOME/libc/$ARCH/sgmga.o /$HOME/libc/$ARCH/sandia_rules.o -lm
if [ $? -ne 0 ]; then
