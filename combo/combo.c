...
*/ 
  ...
  {
    printf ( "\n" );
    printf ( "BAL_SEQ_RANK - Fatal error!\n" );
...
*/ 
  ...
  {
    printf ( "\n" );
    printf ( "BAL_SEQ_SUCCESSOR - Fatal error!\n" );
    printf ( "  The input array is illegal.\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
*/ 
  ...
  {
    printf ( "\n" );
    printf ( "BAL_SEQ_TO_TABLEAU - Fatal error!\n" );
    printf ( "  The input array is illegal.\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
*/
  ...
  {
    printf ( "\n" );
    printf ( "BAL_SEQ_UNRANK - Fatal error!\n" );
  ...
  if ( rank < 0 || nseq < rank )
  {
    printf ( "\n" );
    printf ( "BAL_SEQ_UNRANK - Fatal error!\n" );
    printf ( "  The input rank is illegal.\n" );
    printf ( "  Input rank = %d\n", rank );
    printf ( "  But 0 <= rank < %d is required.\n", nseq );
    exit ( 1 );
  }
...
// 
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "CYCLE_CHECK - Fatal error!\n" );
...
// 
  if ( ncycle < 1 || n < ncycle )
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "CYCLE_CHECK - Fatal error!\n" );
    fprintf ( stderr, "  1 <= NCYCLE <= N is required.\n" );
    exit ( 1 );
  }
// 
//  1 <= INDEX(I) <= N.
//
  for ( i = 0; i < ncycle; i++ )
  {
    if ( index[i] < 1 || n < index[i] )
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "CYCLE_CHECK - Fatal error!\n" );
      fprintf ( stderr, "  1 <= INDEX[I] <= N is required.\n" );
      fprintf ( stderr, "  But index[%d] = %d\n", i, index[i] );
      exit ( 1 );
    }
  }
// 
...
// 
  if ( i4vec_sum ( ncycle, index ) != n )
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "CYCLE_CHECK - Fatal error!\n" );
    fprintf ( stderr, "  INDEX entries must sum to N.\n" );
    exit ( 1 );
  }
// 
//  1 <= T(I) <= N.
// 
  for ( i = 0; i < n; i++ )
  {
    if ( t[i] < 1 || n < t[i] )
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "CYCLE_CHECK - Fatal error!\n" );
      fprintf ( stderr, "  1 <= T[I] <= N is required.\n" );
      exit ( 1 );
    }
  }
// 
...
// 
  for ( iseek = 1; iseek <= n; iseek++ )
  {
    ...
    if ( ifind == -1 )
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "CYCLE_CHECK - Fatal error!\n" );
      fprintf ( stderr, "  The value %d does not occur in T.\n", iseek );
      exit ( 1 );
    }
  }
  return;
...
void dist_next ( int k, int m, int q[], int *more )
...
//    slot.
// 
//    Input/output, int *MORE, used by the user to start the computation,
...
// 
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "EDGE_CHECK - Fatal error!\n" );
    fprintf ( stderr, "  N < 1\n" );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "EDGE_DEGREE - Fatal error!\n" );
    printf ( "  The input array is illegal.\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
//
  d = ( int * ) malloc ( n_node * sizeof ( int ) );
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "GRAY_CODE_RANK - Fatal error!\n" );
    printf ( "  The input array is illegal.\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "GRAY_CODE_SUCCESSOR - Fatal error!\n" );
    printf ( "  The input array is illegal.\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "GRAY_CODE_UNRANK - Fatal error!\n" );
    printf ( "  Input N is illegal.\n" );
    exit ( 1 );
  }
...
//  Purpose:
//
//    I4VEC_PART1 partitions an integer into NPART parts.
// 
//  Example:
// 
//    Input:
...
// 
{
  ...
  {
    printf ( "\n" );
    printf ( "I4VEC_PART1 - Fatal error!\n" );
    printf ( "  The input value of NPART is illegal.\n" );
    exit ( 1 );
  }
...
//  Purpose:
//
//    I4VEC_PART2 partitions an integer into NPART nearly equal parts.
// 
//  Example:
// 
//    Input:
...
// 
{
  ...
  {
    printf ( "\n" );
    printf ( "I4VEC_PART2 - Fatal error!\n" );
    printf ( "  The input value of NPART is illegal.\n" );
    exit ( 1 );
  }
...
// 
{
  ...
  stack = ( double * ) malloc ( maxstack * sizeof ( double ) );
  x_best = ( double * ) malloc ( n * sizeof ( double ) );
    ...
    else if ( indx == 2 )
    {
      ...
      if ( mass_1 <= mass_limit )
      {
        ...
        if ( profit_best < profit_1 + profit_2 )
        {
          ...
          {
            printf ( "\n" );
            printf ( "KNAPSACK_01 - Fatal error!\n" );
            printf ( "  Exceeded stack space.\n" );
            return;
          }
          ncan[k-1] = ncan[k-1] + 1;
          nstack = nstack + 1;
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "KSUBSET_COLEX_CHECK - Fatal error!\n" );
    printf ( "  The input array is illegal.\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "KSUBSET_COLEX_SUCCESSOR - Fatal error!\n" );
    printf ( "  The input array is illegal.\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "KSUBSET_COLEX_UNRANK - Fatal error!\n" );
    printf ( "  Input N is illegal.\n" );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "KSUBSET_LEX_RANK - Fatal error!\n" );
    printf ( "  The input array is illegal.\n" );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "KSUBSET_LEX_SUCCESSOR - Fatal error!\n" );
    printf ( "  The input array is illegal.\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "KSUBSET_LEX_UNRANK - Fatal error!\n" );
    printf ( "  Input N is illegal.\n" );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "KSUBSET_REVDOOR_RANK - Fatal error!\n" );
    printf ( "  The input array is illegal.\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "KSUBSET_REVDOOR_SUCCESSOR - Fatal error!\n" );
    printf ( "  The input array is illegal.\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "KSUBSET_REVDOOR_UNRANK - Fatal error!\n" );
    printf ( "  Input N is illegal.\n" );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "NPART_RSF_LEX_RANK - Fatal error!\n" );
    printf ( "  The input array is illegal.\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
// 
  if ( *rank == -1 )
  {
    ...
    {
      printf ( "\n" );
      printf ( "NPART_RSF_LEX_SUCCESSOR - Fatal error!\n" );
      printf ( "  NPART < 1.\n" );
      exit ( 1 );
    }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "NPART_RSF_LEX_UNRANK - Fatal error!\n" );
  ...
  if ( npart < 1 || n < npart )
  {
    printf ( "\n" );
    printf ( "NPART_RSF_LEX_UNRANK - Fatal error!\n" );
    printf ( "  The input NPART is illegal.\n" );
    exit ( 1 );
  }
...
//
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "PART_SF_CHECK - Fatal error!\n" );
    fprintf ( stderr, "  N < 1.\n" );
    exit ( 1 );
  }
  ...
  if ( npart < 1 || n < npart )
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "PART_SF_CHECK - Fatal error!\n" );
    fprintf ( stderr, "  1 <= NPART <= N is required,\n" );
    fprintf ( stderr, "  but NPART = %d\n", npart );
    exit ( 1 );
  }
// 
//  Every entry must lie between 1 and N.
// 
  for ( i = 0; i < npart; i++ )
  {
    if ( a[i] < 1 || n < a[i] )
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "PART_SF_CHECK - Fatal error!\n" );
      fprintf ( stderr, "  1 <= A[*] <= N is required.\n" );
      fprintf ( stderr, "  but A[%d] = %d\n", i, a[i] );
      exit ( 1 );
    }
  }
// 
...
// 
  for ( i = 1; i < npart; i++ )
  {
    if ( a[i-1] < a[i] )
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "PART_SF_CHECK - Fatal error!\n" );
      fprintf ( stderr, "  The entries are not in descending order.\n" );
      exit ( 1 );
    }
  }
// 
...
// 
  if ( i4vec_sum ( npart, a ) != n )
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "PART_SF_CHECK - Fatal error!\n" );
    fprintf ( stderr, "  The NPART entries of A don't add up to N.\n" );
    fprintf ( stderr, "  N = %d\n", n );
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "PARTN_SUCCESSOR - Fatal error!\n" );
    printf ( "  The input array is illegal.\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
// 
{
  ...
  for ( i = 0; i < n; i++ )
  {
    if ( p[i] < 1 || n < p[i] )
    {
      ...
      fprintf ( stderr, "  but 1 <= p[i] <= %d is required.\n", n );
      exit ( 1 );
    }
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "PERM_LEX_UNRANK - Fatal error!\n" );
    printf ( "  Input N is illegal.\n" );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "PERM_TJ_UNRANK - Fatal error!\n" );
    printf ( "  Input N is illegal.\n" );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "PRUEFER_RANK - Fatal error!\n" );
    printf ( "  Input array is illegal.\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "PRUEFER_SUCCESSOR - Fatal error!\n" );
    printf ( "  The input array is illegal.\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "PRUEFER_TO_TREE - Fatal error!\n" );
    printf ( "  The input array is illegal!\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "PRUEFER_UNRANK - Fatal error!\n" );
    printf ( "  Input N is illegal.\n" );
    exit ( 1 );
  }
...
// 
{
  ...
  d = ( int * ) malloc ( ( m + 1 ) * ( m + 1 ) * sizeof ( int ) );
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "RGF_SUCCESSOR - Fatal error!\n" );
    printf ( "  The input array is illegal!\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "RGF_TO_SETPART - Fatal error!\n" );
    printf ( "  The input array is illegal!\n" );
    printf ( "  IERROR = %d\n", ierror );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "RGF_UNRANK - Fatal error!\n" );
    printf ( "  Input M is illegal.\n" );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "SETPART_TO_RGF - Fatal error!\n" );
    printf ( "  The input array is illegal.\n" );
    exit ( 1 );
  }
...
// 
{
  ...
  s = ( int * ) malloc ( ( m + 1 ) * ( n + 1 ) * sizeof ( int ) );
...
// 
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "SUBSET_CHECK - Fatal error!\n" );
    fprintf ( stderr, "  N < 1.\n" );
    exit ( 1 );
  }
  ...
  for ( i = 0; i < n; i++ )
  {
    if ( t[i] != 0 && t[i] != 1 )
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "SUBSET_CHECK - Fatal error!\n" );
      fprintf ( stderr, "  T[I] = 0 or 1 is required.\n" );
      exit ( 1 );
    }
  }
  return;
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "SUBSET_COLEX_UNRANK - Fatal error!\n" );
    printf ( "  Input N is illegal.\n" );
    exit ( 1 );
  }
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "SUBSET_LEX_UNRANK - Fatal error!\n" );
    printf ( "  Input N is illegal.\n" );
    exit ( 1 );
  }
...
// 
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "TABLEAU_CHECK - Fatal error!\n" );
    fprintf ( stderr, "  N < 1.\n" );
    exit ( 1 );
  }
// 
  ...
  for ( i = 0; i < 2; i++ )
  {
    for ( j = 0; j < n; j++ )
    {
      if ( tab[i+j*2] < 1 || 2 * n < tab[i+j*2] )
      {
        fprintf ( stderr, "\n" );
        fprintf ( stderr, "TABLEAU_CHECK - Fatal error!\n" );
        fprintf ( stderr, "  TAB[I][J] < 1 or N < TAB[I][J].\n" );
        exit ( 1 );
      }
    }
  }
  ...
  for ( i = 0; i < 2; i++ )
  {
    for ( j = 1; j < n; j++ )
    {
      if ( tab[i+j*2] <= tab[i+(j-1)*2] )
      {
        fprintf ( stderr, "\n" );
        fprintf ( stderr, "TABLEAU_CHECK - Fatal error!\n" );
        fprintf ( stderr, "  TAB[I][J] < TAB[I][J-1].\n" );
        exit ( 1 );
      }
    }
  }
...
// 
  ...
  for ( j = 0; j < n; j++ )
  {
    if ( tab[i+j*2] <= tab[i-1+j*2] )
    {
      fprintf ( stderr, "\n" );
      fprintf ( stderr, "TABLEAU_CHECK - Fatal error!\n" );
      fprintf ( stderr, "  TAB[I][J] <= TAB[I-1][J].\n" );
      exit ( 1 );
    }
  }
  return;
...
// 
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "TREE_CHECK - Fatal error!\n" );
    fprintf ( stderr, "  N < 1.\n" );
    exit ( 1 );
  }
  ...
  for ( i = 0; i < 2; i++ )
  {
    for ( j = 0; j < n - 1; j++ )
    {
      if ( t[i+j*2] < 1 || n < t[i+j*2] )
      {
        fprintf ( stderr, "\n" );
        fprintf ( stderr, "TREE_CHECK - Fatal error!\n" );
        fprintf ( stderr, "  1 <= T[I][J] <= N is required.\n" );
        exit ( 1 );
      }
    }
  }
  ...
  for ( k = 1; k <= n - 1; k++ )
  {
    ...
    while ( d[x-1] != 1 )
    {
      ...
      if ( n < x )
      {
        fprintf ( stderr, "\n" );
        fprintf ( stderr, "TREE_CHECK - Fatal error!\n" );
        fprintf ( stderr, "  Could not locate a node of degree 1.\n" );
        exit ( 1 );
      }
    }
// 
...
// 
    ...
    for ( ; ; )
    {
      ...
      if ( n < j )
      {
        fprintf ( stderr, "\n" );
        fprintf ( stderr, "TREE_CHECK - Fatal error!\n" );
        fprintf ( stderr, "  Hard to explain.\n" );
        exit ( 1 );
      }
    }
// 
...
// 
  ...
  {
    printf ( "\n" );
    printf ( "TREE_UNRANK - Fatal error!\n" );
    printf ( "  Input N is illegal.\n" );
    exit ( 1 );
  }
