#!/bin/bash
#
gcc -c -g -I/$HOME/include pwl_interp_1d_prb.c >& compiler.txt
if [ $? -ne 0 ]; then
  echo "Errors compiling pwl_interp_1d_prb.c"
  exit
fi
rm compiler.txt
#
gcc pwl_interp_1d_prb.o /$HOME/libc/$ARCH/pwl_interp_1d.o \
...
#
echo "Program output written to pwl_interp_1d_prb_output.txt"
