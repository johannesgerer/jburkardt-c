...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "F00_F0 - Fatal error!\n" );
    fprintf ( stderr, "  Illegal function index FI = %d\n", fi );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "F00_F1 - Fatal error!\n" );
    fprintf ( stderr, "  Illegal function index FI = %d\n", fi );
    exit ( 1 );
  }
  return;
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "F00_F2 - Fatal error!\n" );
    fprintf ( stderr, "  Illegal function index FI = %d\n", fi );
    exit ( 1 );
  }
  return;
...
/*
  ...
  Parameters:
    ...
    Output, char *FT, the function title.
*/
{
  if ( fi == 1 )
  {
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "F00_TITLE - Fatal error!\n" );
    fprintf ( stderr, "  Illegal function index FI = %d\n", fi );
    exit ( 1 );
  }
  return;
...
*/
{
  strcpy ( ft, "Synergistic Gaussian" );
...
*/
{
  strcpy ( ft, "Cloverleaf Asymmetric Peak/Valley" );
...
*/
{
  strcpy ( ft, "Vicente Romero function" );
...
*/
{
  strcpy ( ft, "Rescaled Runge function" );
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "G00_SIZE - Fatal error!\n" );
    fprintf ( stderr, "  Illegal grid index GI = %d\n", gi );
    exit ( 1 );
  }
  return gn;
}
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "G00_TITLE - Fatal error!\n" );
    fprintf ( stderr, "  Illegal grid index GI = %d\n", gi );
    exit ( 1 );
  }
  return;
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "G00_XY - Fatal error!\n" );
    fprintf ( stderr, "  Illegal grid index GI = %d\n", gi );
    exit ( 1 );
  }
  return;
...
*/
{
  strcpy ( gt, "Franke's 100 node set" );
...
*/
{
  strcpy ( gt, "Franke's 33 node set" );
...
*/
{
  strcpy ( gt, "Lawson's 25 node set" );
