...
void            c8mat_copy ( int m, int n, double complex a[], 
                  double complex b[] );
...
double complex *c8mat_minvm_new ( int n1, int n2, double complex a[], 
                  double complex b[] );
void            c8mat_mm ( int n1, int n2, int n3, double complex a[], 
...
void            c8mat_print_some ( int m, int n, double complex a[], int ilo, 
                  int jlo, int ihi, int jhi, char *title );
void            c8mat_scale ( int m, int n, double complex alpha, 
                  double complex a[] );
...
void            c8vec_print_part ( int n, double complex a[], int max_print, 
                  char *title );
