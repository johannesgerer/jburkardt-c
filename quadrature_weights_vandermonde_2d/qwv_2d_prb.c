...
*/
{
  ...
  printf ( "QWV_2D_PRB:\n" );
  printf ( "  C version\n" );
  printf ( "  Test the QWV_2D library.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST01:\n" );
  printf ( "  Compute the weights associated with an interpolatory\n" );
  printf ( "  quadrature rule defined by N=(T+1)*(T+2)/2 points,\n" );
  printf ( "  exact for polynomials of total degree T or less.\n" );
  printf ( "\n" );
  printf ( "  Degree T = %d\n", t );
  printf ( "  Number of points N = %d\n", n );
  printf ( "  X Interval = [%g,%g]\n", a, b );
  printf ( "  Y Interval = [%g,%g]\n", c, d );
/*
  Set the points.
*/
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "PADUA_POINT_SET - Fatal error!\n" );
    printf ( "  Illegal value of L = %d\n", l );
