...
*/
{
  timestamp ( );
  printf ( "\n" );
  printf ( "SPARSE_DISPLAY_PRB\n" );
  printf ( "  C version\n" );
  printf ( "  Test the SPARSE_DISPLAY library.\n" );
...
*/
{
  printf ( "\n" );
  printf ( "TEST02\n" );
  printf ( "  SPY_FILE generates a sparsity plot for a matrix for\n" );
  printf ( "  which there exists a file containing all the pairs\n" );
  printf ( "  (I,J) corresponding to nonzero entries.\n" );
...
*/
{
  ...
  printf ( "  SPY_GE generates a sparsity plot for a matrix stored\n" );
  printf ( "  in general (GE) format.\n" );
  printf ( "  Just to orient ourselves, generate an upper triangular matrix.\n" );
