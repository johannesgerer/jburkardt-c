...
/*
  Purpose:
    ...
    MAIN is the main program for CYCLE_BRENT_PRB.

  Discussion:

    CYCLE_BRENT_PRB tests the CYCLE_BRENT library.
...
*/
{
  ...
  printf ( "\n" );
  printf ( "CYCLE_BRENT_PRB\n" );
  printf ( "  C version\n" );
  printf ( "  Test the CYCLE_BRENT library.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST02\n" );
  printf ( "  Test CYCLE_BRENT for F2().\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST03\n" );
  printf ( "  Test CYCLE_BRENT for F3().\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST04\n" );
  printf ( "  Test CYCLE_BRENT for F4().\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST05\n" );
  printf ( "  Test CYCLE_BRENT for F5().\n" );
