...
int polygon_contains_point ( int n, double v[], double p[2] )
...
/*
  ...
  Parameters:
    ...
    Output, int POLYGON_CONTAINS_POINT, is TRUE if the point
...
int polygon_contains_point_2 ( int n, double v[], double p[2] )
...
/*
  ...
  Parameters:
    ...
    Output, int POLYGON_CONTAINS_POINT_2, is TRUE if the point
    is inside the polygon or on its boundary, and FALSE otherwise.
*/
{
  int i;
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "POLYGON_INRAD_DATA - Fatal error!\n" );
    fprintf ( stderr, "  Input value of N must be at least 3,\n" );
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "POLYGON_INTEGRAL_1 - Fatal error!\n" );
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "POLYGON_INTEGRAL_X - Fatal error!\n" );
    fprintf ( stderr, "  The number of vertices must be at least 3.\n" );
    fprintf ( stderr, "  The input value of N = %d\n", n );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "POLYGON_INTEGRAL_XX - Fatal error!\n" );
    fprintf ( stderr, "  The number of vertices must be at least 3.\n" );
    fprintf ( stderr, "  The input value of N = %d\n", n );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "POLYGON_INTEGRAL_XY - Fatal error!\n" );
    fprintf ( stderr, "  The number of vertices must be at least 3.\n" );
    fprintf ( stderr, "  The input value of N = %d\n", n );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "POLYGON_INTEGRAL_Y - Fatal error!\n" );
    fprintf ( stderr, "  The number of vertices must be at least 3.\n" );
    fprintf ( stderr, "  The input value of N = %d\n", n );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "POLYGON_INTEGRAL_YY - Fatal error!\n" );
    fprintf ( stderr, "  The number of vertices must be at least 3.\n" );
    fprintf ( stderr, "  The input value of N = %d\n", n );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "POLYGON_OUTRAD_DATA - Fatal error!\n" );
    fprintf ( stderr, "  Input value of N must be at least 3,\n" );
    fprintf ( stderr, "  but your input value was N = %d\n", n );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "POLYGON_SIDE_DATA - Fatal error!\n" );
    fprintf ( stderr, "  Input value of N must be at least 3,\n" );
    fprintf ( stderr, "  but your input value was N = %d\n", n );
    exit ( 1 );
  }
...
*/
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "TRIANGLE_BARYCENTRIC - Fatal error!\n" );
...
int triangle_contains_point_1 ( double t[2*3], double p[2] )
...
/*
  ...
  Parameters:
    ...
    Output, int TRIANGLE_CONTAINS_POINT_1, is TRUE if the points 
