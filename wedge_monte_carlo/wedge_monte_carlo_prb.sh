#!/bin/bash
#
gcc -c -I/$HOME/include wedge_monte_carlo_prb.c
if [ $? -ne 0 ]; then
  echo "Errors compiling wedge_monte_carlo_prb.c"
  exit
fi
#
gcc -o wedge_monte_carlo_prb wedge_monte_carlo_prb.o /$HOME/libc/$ARCH/wedge_monte_carlo.o -lm
if [ $? -ne 0 ]; then
