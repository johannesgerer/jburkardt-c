...
//
{
  ...
  strcpy ( title, "f(x) = steps -1/2/1 at [0,1/3], [1/3,4/5], [4/5,1]." );
...
//
{
  ...
  strcpy ( title, "f(x) = (1-3x), x < 1/3 (6x-2) if 1/3 < x" );
...
//
{
  ...
  strcpy ( title, "f(x) = x (10*x-1) (5x-2) (5x-2) (4x-3.4) (x-1)" );
...
//
{
  ...
  strcpy ( title, 
    "f(x) = cos(7*x)+5*cos(11.2*x)-2*cos(14*x)+5*cos(31.5*x)+7*cos(63*x)." );
...
//
{
  ...
  title = ( char * ) malloc ( 80 * sizeof ( char ) );
  strcpy ( title, "f(x) = exp ( 2 x ) if x < 0.5, 0 otherwise" );
...
//
{
  ...
  title = ( char * ) malloc ( 80 * sizeof ( char ) );
  strcpy ( title, "f(x) = 1 / ( 1 + ( 10 * (x-1/2) )^2 )" );
