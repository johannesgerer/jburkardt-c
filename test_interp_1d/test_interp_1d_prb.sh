#!/bin/bash
#
gcc -c -g -I/$HOME/include test_interp_1d_prb.c >& compiler.txt
if [ $? -ne 0 ]; then
  echo "Errors compiling test_interp_1d_prb.c"
  exit
fi
rm compiler.txt
#
gcc test_interp_1d_prb.o /$HOME/libc/$ARCH/test_interp_1d.o /$HOME/libc/$ARCH/r8lib.o -lm
if [ $? -ne 0 ]; then
