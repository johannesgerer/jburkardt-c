...
*/
{
  ...
  printf ( "\n" );
  printf ( "SQUARE_EXACTNESS_PRB\n" );
  printf ( "  C version\n" );
  printf ( "  Test the SQUARE_EXACTNESS library.\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST01\n" );
  printf ( "  Product Gauss-Legendre rules for the 2D Legendre integral.\n" );
  printf ( "  Density function rho(x) = 1.\n" );
  printf ( "  Region: -1 <= x <= +1.\n" );
  printf ( "  Region: -1 <= y <= +1.\n" );
  printf ( "  Level: L\n" );
  printf ( "  Exactness: 2*L+1\n" );
  printf ( "  Order: N = (L+1)*(L+1)\n" );
...
*/
{
  ...
  printf ( "\n" );
  printf ( "TEST02\n" );
  printf ( "  Padua rule for the 2D Legendre integral.\n" );
  printf ( "  Density function rho(x) = 1.\n" );
  printf ( "  Region: -1 <= x <= +1.\n" );
  printf ( "  Region: -1 <= y <= +1.\n" );
  printf ( "  Level: L\n" );
  printf ( "  Exactness: L+1 when L is 0,\n" );
  printf ( "             L   otherwise.\n" );
  printf ( "  Order: N = (L+1)*(L+2)/2\n" );
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "PADUA_POINT_SET - Fatal error!\n" );
...
*/
{
  ...
  {
    fprintf ( stderr, "\n" );
    fprintf ( stderr, "PADUA_WEIGHT_SET - Fatal error\n" );
    fprintf ( stderr, "  Illegal value of L = %d\n", l );
