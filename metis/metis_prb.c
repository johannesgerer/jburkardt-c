...
int VerifyPartmC ( int nvtxs, int ncon, idxtype *xadj, idxtype *adjncy, 
  idxtype *vwgt, idxtype *adjwgt, int nparts, float *ubvec, int edgecut, 
  idxtype *part);
int VerifyPartV(int nvtxs, idxtype *xadj, idxtype *adjncy, idxtype *vwgt, 
  idxtype *vsize, int nparts, int totalv, idxtype *part);
int VerifyWPart ( int nvtxs, idxtype *xadj, idxtype *adjncy, 
  idxtype *vwgt, idxtype *adjwgt, int nparts, float *tpwgts, int edgecut, 
  idxtype *part);
