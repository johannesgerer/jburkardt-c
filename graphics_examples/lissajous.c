...
/*
  Purpose:
    ...
    LISSAJOUS uses DISLIN to draw a plot of a Lissajous planar curve.
...
*/
{
  ...
  printf ( "LISSAJOUS:\n" );
  printf ( "  C version:\n" );
  printf ( "  Use DISLIN routines to plot (X,Y) data as a plane curve.\n" );
/*
  Read the data.
*/
  r4mat_header_read ( "lissajous.txt", &m, &n );

  xy = r4mat_data_read ( "lissajous.txt", m, n );
/*
...
*/
  simplx ( );
/*
  Set the axis origin plot units to the right, and plot units DOWN.
*/
  axspos ( 180, 2400 );
/*
...
*/
  graf ( -1.1, 1.1, -1.0, 0.2, -1.1, 1.1, -1.0, 0.2 );
/*
...
/*
  Define the title.
*/
  titlin ( "Lissajous Curve", 1 );
  titlin ( "x=sin(3t+pi/2), y=sin(4t)", 2 );
  title ( );
/*
