...
/*
  Purpose:
    ...
    GEYSER uses DISLIN to draw a bar chart.
...
*/
{
  ...
  printf ( "GEYSER:\n" );
  printf ( "  C version\n" );
  printf ( "  Use DISLIN routines to make a bar chart.\n" );
/*
  Read the data.
*/
  r4mat_header_read ( "geyser_binned.txt", &m, &n );

  xy = r4mat_data_read ( "geyser_binned.txt", m, n );
/*
...
*/
  graf ( 40.0, 110.0, 40.0, 10.0, 0.0, 60.0, 0.0, 10.0 );
/*
  BEGIN LEVEL 2 COMMANDS.

  Define the title.
*/
  titlin ( "Time between eruptions of Old Faithful", 1 );
  title ( );
/*
...
*/
  ...
  zero = ( float * ) malloc ( n * sizeof ( float ) );
