...
/*
  Purpose:
    ...
    SURFACE_GRID uses DISLIN to display Z(X,Y) data as a surface.
...
*/
{
  ...
  printf ( "SURFACE_GRID:\n" );
  printf ( "  C version:\n" );
  printf ( "  Use DISLIN to plot Z(X,Y) data as a surface.\n" );
/*
  Read the data.
*/
  r4mat_header_read ( "surface_grid.txt", &m, &nn );

  xyz = r4mat_data_read ( "surface_grid.txt", m, nn );
/*
  Split the data.
*/
  n = 41;
...
*/
  simplx ( );
/*
  Set the axis origin 80 plot units to the right, and 2500 plot units DOWN.
*/
  axspos ( 80, 2500 );
/*
...
/*
  Define the title.
*/
  titlin ( "Surface plot of 41x41 table Z(X,Y)", 1 );
  title ( );
/*
