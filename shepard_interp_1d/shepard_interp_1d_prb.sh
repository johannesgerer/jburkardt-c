#!/bin/bash
#
gcc -c -g -I/$HOME/include shepard_interp_1d_prb.c >& compiler.txt
if [ $? -ne 0 ]; then
  echo "Errors compiling shepard_interp_1d_prb.c"
  exit
fi
rm compiler.txt
#
gcc shepard_interp_1d_prb.o /$HOME/libc/$ARCH/shepard_interp_1d.o \
...
#
echo "Program output written to shepard_interp_1d_prb_output.txt"
